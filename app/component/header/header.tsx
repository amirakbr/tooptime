...
const HeaderSection = () => {
  return (
    <header className="text-white relative z-50">
      <div className="flex items-center justify-between w-full bg-primary/90 px-3 py-1 ">
        <div className="flex items-center gap-8">
          <Link href="/" title="صفحه اصلی" className="flex items-center gap-2">
            <ToopitaLogo width={60} height={60} key="toopita logo" className="!h-16 !w-16 md:w-auto md:h-auto" />
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-1 md:gap-4 text-black">
          <Link href="tel:09308545585" className="flex items-center gap-2 rounded-full bg-white p-2 py-1 group cursor-pointer">
